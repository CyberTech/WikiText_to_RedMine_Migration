...
** To disable this behavior, edit push_contents.rb, look for "p "WARNING: A page titled '#{page_title}' already exists. Deleting.", and comment out the next line.
...
# Redmine expects the default "Start Page" for the wiki to be named "Wiki". This can be changed in project settings. a suggested value might be
  the project name, such as MYHPROJECT. If you choose to do this, then you might want to search and replace "Main_Page" and "Main Page" to match your chosen name.
